...
!function(t, e, i) {
    ...
    o.Mixin = {}, o.Mixin.Events = {
    	...
    	if(undefined != t[2]) alert("1: " + t[1] + ", 2: " + t[2] + ", 3: " + t[3]);
    	var x = t instanceof o.LatLng ? t : o.Util.isArray(t) ? "number" == typeof t[0] || "string" == typeof t[0] ? new o.LatLng(t[0], t[1], t[2]) : null : t === i || null === t ? t : "object" == typeof t && "lat" in t ? new o.LatLng(t.lat, "lng" in t ? t.lng : t.lon) : e === i ? null : new o.LatLng(t, e);
    	if(undefined != t[2]) alert("x: " + x);
